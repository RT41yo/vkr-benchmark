...
def main() -> None:
    ...
    print("KL P_ref->Q mean (bits/token):", _format_metric(distortion.kl_ref_to_stego_mean_bits))
    print("KL P_ref->Q median (bits/token):", _format_metric(distortion.kl_ref_to_stego_median_bits))
    print("KL P_ref->Q p95 (bits/token):", _format_metric(distortion.kl_ref_to_stego_p95_bits))
    print("KL P_ref->Q max (bits/token):", _format_metric(distortion.kl_ref_to_stego_max_bits))
    print("KL P_ref->Q infinite steps:", distortion.kl_ref_to_stego_infinite_steps)
    print("KL P_ref->Q finite steps:", distortion.kl_ref_to_stego_finite_steps)
    print("KL Q->P_ref mean (bits/token):", _format_metric(distortion.kl_stego_to_ref_mean_bits))
    print("KL Q->P_ref median (bits/token):", _format_metric(distortion.kl_stego_to_ref_median_bits))
    print("KL Q->P_ref p95 (bits/token):", _format_metric(distortion.kl_stego_to_ref_p95_bits))
    print("KL Q->P_ref max (bits/token):", _format_metric(distortion.kl_stego_to_ref_max_bits))
    print("KL Q->P_ref infinite steps:", distortion.kl_stego_to_ref_infinite_steps)
    print("KL Q->P_ref finite steps:", distortion.kl_stego_to_ref_finite_steps)
